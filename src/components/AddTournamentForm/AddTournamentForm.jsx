      ...
      <div>
        <div className="form-container">
          <form autoComplete="off" onSubmit={this.handleSubmit}>
            ...
            <input type="text" name="tname" value={this.state.tname} onChange={this.handleChange} required />
            <label>Dates</label>
            <input type="text" name="tdate" value={this.state.tdate} onChange={this.handleChange} required />
            <label>Teams</label>
            <input type="text" name="teams" value={this.state.teams} onChange={this.handleChange} required />
            
            <button type="submit" disabled={disable}>Add Tournament</button>
          </form>
        </div>
